...
///   ¦U©Ð¶¡¬Û¾ק²M³ז¡]kitchenNodes / livingRoomNodes / dadRoomNodes¡^
/// </summary>
public class ExperimentRunner : MonoBehaviour
{
    ...
    // שששששששששששששששששששששששששששששששששששששששששששששששששששששששששששששששששששששששששששששששששששששששששששששששששששששששששששש
    // »²§U¡GPOST µךÀÀ®É¶¡¨ל«ב÷Ý
    //
    // Fire-and-forget¡G©I¥s«ב¥‗§Y×נ¦^¡A¤£µ¥«ב÷Ý¦^À³
    ...
    IEnumerator PostVirtualHourRoutine(float hour)
    {
        ...
        if (req.result != UnityWebRequest.Result.Success)
            Debug.LogWarning($"[Exp] PostVirtualHour ¥¢±Ñ: {req.error}¡]Flask ¥¼±Ò°Ê®É¥i©¿²¤¡^");
    }
